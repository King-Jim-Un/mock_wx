...
class Preferences(AppSettings):
    ...
    replace_background: wx.Colour = field(default_factory=lambda: wx.Colour(159, 159, 159))
    ...
    hover_replace_text: wx.Colour = field(default_factory=lambda: wx.Colour(159, 159, 159))
    hover_replace_delete_background: wx.Colour = field(default_factory=lambda: wx.Colour(106, 32, 32))
    hover_replace_delete_text: wx.Colour = field(default_factory=lambda: wx.Colour(0, 0, 0))
    hover_replace_insert_background: wx.Colour = field(default_factory=lambda: wx.Colour(54, 124, 54))
